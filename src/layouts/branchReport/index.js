...
function BranchEmployeeReport() {
    ...
    const handleDownloadPDF = async (info) => {
        setReportData(null);
        try {
            const response = await fetchBranchEmployeeReport(info);
            if(response) {
...
export default BranchEmployeeReport;